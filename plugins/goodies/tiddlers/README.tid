...
<b>Important:</b> as of version 0.0.15, there is a name change. If you have installed v.0.0.7 or previously, you need to manually delete [$:/plugins/chris2fr/tiddlybox](#[$:/plugins/chris2fr/tiddlybox).  Old configuration files need to be deleted, replaced or moved to howwownow/goodies.
